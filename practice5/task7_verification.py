...
def make_model():
    ...
    graph.connect_dir(room0, room1)
    graph.connect_dir(room0, room2)
    graph.connect_dir(room0, room3)

    graph.connect_dir(room1, room2)
    graph.connect_dir(room1, room0)

    graph.connect_dir(room3, room4)
    graph.connect_dir(room3, room5)

    graph.connect_dir(room4, room3)
    graph.connect_dir(room4, room5)

    graph.connect_dir(room5, room4)
    graph.connect_dir(room5, room3)
